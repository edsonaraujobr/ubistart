...
import { type UnknownKeysParam, ZodError, type ZodObject, type ZodTypeAny } from 'zod';
...
type ZodObjectSchema<Output> = ZodObject<any, UnknownKeysParam, ZodTypeAny, Output>;

export interface HttpClientOptions<Output> {
  method: HttpMethods;
  url: string;
  responseSchema: ZodObjectSchema<Output> | null;
  baseURL?: string;
